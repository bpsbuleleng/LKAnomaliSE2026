...
var MockData = {
  ...
  QUESTIONS: [
    ...
    { question_id: 'r26a', jenis: 'usaha', order: 9, label: 'Balas jasa pekerja setahun (Rp)', type: 'currency', options: null, required: false, help: '', active: true, roster_group: '' },
    { question_id: 'r26b', jenis: 'usaha', order: 10, label: 'Biaya bahan baku/produksi setahun (Rp)', type: 'currency', options: null, required: false, help: '', active: true, roster_group: '' },
    { question_id: 'r26c', jenis: 'usaha', order: 11, label: 'Biaya sewa dan jasa setahun (Rp)', type: 'currency', options: null, required: false, help: '', active: true, roster_group: '' },
    { question_id: 'r26d', jenis: 'usaha', order: 12, label: 'Biaya operasional lainnya setahun (Rp)', type: 'currency', options: null, required: false, help: '', active: true, roster_group: '' },
    { question_id: 'r26e', jenis: 'usaha', order: 13, label: 'Biaya lainnya setahun (Rp)', type: 'currency', options: null, required: false, help: '', active: true, roster_group: '' },
    { question_id: 'r27c', jenis: 'usaha', order: 14, label: 'Pendapatan usaha setahun (Rp)', type: 'currency', options: null, required: true, help: '', active: true, roster_group: '' },
    { question_id: 'r28c', jenis: 'usaha', order: 15, label: 'Perkiraan nilai aset usaha (Rp)', type: 'currency', options: null, required: false, help: '', active: true, roster_group: '' },
    { question_id: 'r29c', jenis: 'usaha', order: 16, label: 'Penyertaan modal dari korporasi (Rp)', type: 'currency', options: null, required: false, help: '', active: true, roster_group: '' },
    { question_id: 'r29d', jenis: 'usaha', order: 17, label: 'Penyertaan modal dari lembaga non-korporasi (Rp)', type: 'currency', options: null, required: false, help: '', active: true, roster_group: '' },
